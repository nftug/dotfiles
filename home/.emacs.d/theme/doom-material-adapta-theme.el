;;; doom-material-adapta-theme.el --- inspired by Material Theme by equinusocio  -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-material-adapta-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-material-adapta-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-material-adapta-theme
  :type '(choice integer boolean))

;;
(def-doom-theme doom-material-adapta
  "A dark theme inspired by Material Theme by equinusocio"

  ;; name        default   256       16
  ((bg         '("#263238" nil     nil))
   (bg-alt     '("#1C262B" "black"       nil))
   ...
   (cyan        '("#00bcd4" "#5fd7ff" "brightcyan"))
   (dark-cyan   '("#4db6ac" "#00d7af" "cyan"))
   ...
   (-modeline-pad
    (when doom-material-adapta-padded-modeline
      (if (integerp doom-material-adapta-padded-modeline) doom-material-adapta-padded-modeline 4))))
  ...
  (((lazy-highlight &override) :background base4 :foreground fg :distant-foreground fg :bold bold)
   ...
   ;; --- major-mode faces ------------------------
   ;; man-mode
   (Man-overstrike :inherit 'bold :foreground dark-cyan)
   ...
   ;; tooltip
   (tooltip              :background (doom-lighten bg 0.1) :foreground fg)

   ;; added
   (fringe :inherit 'default :foreground comments)
   (highlight            :background highlight  :foreground fg :distant-foreground base8)
   (swiper-line-face    :background cyan    :foreground fg)
   (ivy-posframe :background bg-alt)
   ((line-number &override) :foreground base7)
   ((line-number-current-line &override) :foreground fg)
   ))

(provide 'doom-material-adapta-theme)
